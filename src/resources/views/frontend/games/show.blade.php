...
<body>
    ...
    <div class="content-left">
        <div class="main-preview">
            <img src="{{ asset('imgs/hk-preview1.png') }}" class="featured-image">
        ...
        <div class="thumbnail-list">
            <div class="thumb"><img src="{{ asset('imgs/hk-preview2.png') }}"></div>
            <div class="thumb active"><img src="{{ asset('imgs/hk-preview1.png') }}"></div>
            <div class="thumb"><img src="{{ asset('imgs/hk-preview3.png') }}"></div>
            <div class="thumb"><img src="{{ asset('imgs/hk-preview4.png') }}"></div>
        </div>
        ...
        <div class="platform-section">
            ...
            <div class="platform-options">
                <div class="platform-card active">
                    <span>Steam</span>
                    <img src="{{ asset('icons/steam-icon.svg') }}">
                </div>
                <div class="platform-card">
                    <span>Epic Games</span>
                    <img src="{{ asset('icons/epic-games-icon.svg') }}">
                </div>
            </div>
        </div>
        ...
        @for ($i = 0; $i < 6; $i++)
            <div class="game-card">
                <div class="game-cover">
                    <img src="{{ asset('imgs/replaced-poster.png') }}">
                </div>

                <div class="game-info">
                    <div class="game-title">Replaced</div>

                    <div class="price-row">
                        <span class="game-discount">-60%</span>
                        <span class="game-old-price">$40.00</span>
                        <span class="game-new-price">$24.00</span>
                    </div>
                </div>
            </div>
        @endfor
